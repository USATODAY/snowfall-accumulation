...
def generate_hex_grid(bounds, hex_size):
    ...
    dx = hex_size * 3**0.5  # Horizontal spacing
    dy = hex_size * 1.5  # Vertical spacing
    ...
    while y < ymax + dy:
        ...
        while x < xmax + dx:
            hexagon = Polygon([
                (x, y),
                (x + hex_size * 3**0.5 / 2, y + hex_size * 0.5),
                (x + hex_size * 3**0.5 / 2, y + hex_size * 1.5),
                (x, y + hex_size * 2),
                (x - hex_size * 3**0.5 / 2, y + hex_size * 1.5),
                (x - hex_size * 3**0.5 / 2, y + hex_size * 0.5),
                (x, y)
